...
async def get_ai_response(user_input, history):
    ...
    try:
        ...
        messages = [{"role": "system", "content": "You are BATMAN'S VIRTUAL ASSISTANT and keep shorter texts. ask for passcode for verification... if he says 'varsha' then proceed talking to him as batman's AI, or else say you are not batman.."}] + history + [{"role": "user", "content": user_input}]
